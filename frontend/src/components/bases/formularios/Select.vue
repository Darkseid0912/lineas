...
const selectClass = computed(() => {
  const base = 'block w-full rounded-md border bg-white text-slate-900 shadow-sm focus:outline-none focus:ring-2 transition-colors duration-200 disabled:bg-slate-100 disabled:text-slate-500'
  const sizes = {
